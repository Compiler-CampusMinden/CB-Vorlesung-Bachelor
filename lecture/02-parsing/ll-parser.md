...
Syntaxanalyse ist die Bestimmung, ob Eingabedaten einer vorgegebenen Syntax
entsprechen.
...
Wir beshäftigen uns heute mit LL-Parsing, mit dem man eine Teilmenge der eindeutigen
...
Parsergeneratoren (hier: ANTLR), deren Eingabe eine LL(k)- (meist LL(1)-) Grammatik
ist, und die als Ausgabe den Quellcode eines (effizienten) tabellengesteuerten
Parsers generieren.
...
Hier ist $\perp$ das Endezeichen des Inputs. Statt $First_1(\alpha)$ wird oft nur
$First(\alpha)$ geschrieben.
